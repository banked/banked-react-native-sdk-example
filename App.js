...
export class ExposedAlert {
  alert(message) {
      alert(message);
  }
}

const exposedAlert = new ExposedAlert();
BatchedBridge.registerCallableModule("JavaScriptExposedAlert", exposedAlert);
